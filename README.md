...
Mobile-first React + Vite app for Italian driving-license study with quiz practice, vocabulary drills, adaptive review, topic study material, and offline usage.
...
## Quiz modes and translation
- Quiz modes: Full quiz, Topic-wise quiz, Review mistakes, and Exam simulator.
- Exam simulator uses Settings values for question count, max errors, and optional timer.
- In non-simulator quiz/study flows, use **Translate to English** buttons (on-demand network request + local cache).
